  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
        {videoData.map((item) => (
          <div key={item.id} className="border px-4 sm:px-11 md:px-8 lg:px-17 xl:px-20  pt-6 sm:pt-2 md:pt-2 lg:pt-3 xl:pt-4">
            <video src={item.src} loop autoPlay />
            <div className="h-[100px] flex justify-center items-center">{item.msg}</div>
          </div>
        ))}
      </div>
    </div>
